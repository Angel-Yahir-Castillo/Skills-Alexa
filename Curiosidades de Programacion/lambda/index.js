...
const languageFacts = {
  ...
  python: [
    ...
    "se utiliza para desarrollar aplicaciones de todo tip",
  ],
  php: [
    "es un lenguaje de programación interpretado​ del lado del servidor",
    "es de uso general que se adapta especialmente al desarrollo web",
    "Fue creado inicialmente por el programador danés-canadiense Rasmus Lerdorf en 1994",
  ],
  matlab: [
    "Está disponible para las plataformas Unix, Windows, macOS y GNU/Linux.",
    "Es un Software matemático",
    "opera principalmente en arreglos y matrices, tanto de forma total como parcial.",
  ],
  c: [
    "es un lenguaje de programación de propósito general",
    "es un lenguaje de nivel medio bajo",
    "se caracteriza por la capacidad de manipular direcciones arbitrarias",
  ],
};
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'puedo darte datos curiosos de algún lenguaje de programación, di algo como "prueba JavaScript';
